...
ul.pagination{display:inline-block;padding:0;margin:0;font-size:1.2em;color:#85f665}ul.pagination li{display:inline;margin-left:1em}ul.pagination li a{color:#000;padding:8px 16px;text-decoration:none}ul.pagination li a.active{background-color:silver;color:#fff}ul.pagination li.active{background-color:#85f665;color:#f5f5f5;padding:8px 16px}ul.pagination li a:hover:not(.active){background-color:#888a85}
/* <!-- Bootstrap stuff--> */
