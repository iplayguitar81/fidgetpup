@extends('layout')
@section('title', 'Pet Tricks News')
@section('content')

    <h1 class="article-title-show">pet tricks news</h1>
    <p class="text-center">Here you can check out other cool tricks by other radical pets!</p>
    <hr>
