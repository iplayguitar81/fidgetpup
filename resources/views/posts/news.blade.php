                ...
                @foreach($news as $item)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <h2 class="secondary-posts-title"><a class="" href="{{ route('posts.show', [$item->id, str_slug($item->title)]) }}">{{ ucwords($item->title)}}</a> <a class="small-folder" href="{{ route_articles($result->category)}}"><span class="glyphicon glyphicon-folder-open"></span>{{$result->category}}</a></h2>
