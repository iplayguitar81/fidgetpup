                ...
                @foreach($news as $item)
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                ...
                                <h2 class="secondary-posts-title"><a class="" href="{{ route('posts.show', [$item->id, str_slug($item->title)]) }}">{{ ucwords($item->title)}}</a> <a class="small-folder" href=""><span class="glyphicon glyphicon-folder-open"></span></a></h2>
